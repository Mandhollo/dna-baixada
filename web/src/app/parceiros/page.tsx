...
function EstabelecimentoCard({
  ...
  return (
    <Link href={`/parceiros/${est.slug}`}>
      ...
      >
        {/* Image / gradient */}
        <div className="relative h-48 w-full overflow-hidden bg-gradient-to-br from-[#0A2463] to-[#14A76C]">
          {est.foto_url ? (
            <Image
              src={est.foto_url}
              alt={est.nome}
          ...
          {/* Verified badge */}
          {est.verificado && (
            <span className="absolute right-3 top-3 flex items-center gap-1 rounded-full bg-white/90 px-2.5 py-1 text-[11px] font-bold text-[#14A76C] backdrop-blur">
        ...
        <div className="flex flex-1 flex-col p-4">
          <h3 className="text-base font-bold text-[#0A2463] line-clamp-1">
            {est.nome}
          </h3>
          ...
          <div className="mt-auto flex items-center justify-end pt-3 text-xs font-semibold text-[#14A76C] opacity-0 transition group-hover:opacity-100">
...
function CampanhaCard({
  ...
  return (
    ...
    >
      ...
      <h4 className="mt-1 text-sm font-bold text-[#0A2463]">{campanha.titulo}</h4>
      ...
      {campanha.codigo_cupom && (
        ...
        >
          ...
          {copied ? (
            <Check size={16} className="text-[#14A76C]" />
          ) : (
        ...
        <div className="rounded-2xl bg-white p-5 shadow-lg">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-xl border border-gray-200 bg-gray-50 py-3 pl-11 pr-4 text-sm text-gray-800 outline-none transition focus:border-[#14A76C] focus:ring-2 focus:ring-[#14A76C]/20"
            />
          </div>
      ...
      {campanhas.length > 0 && (
        <section className="mx-auto mt-12 max-w-6xl px-6">
          ...
          >
            ...
            <h2 className="text-xl font-extrabold text-[#0A2463]">Promoções Ativas</h2>
          </motion.div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-gray-200 py-20 text-center">
            ...
            <button
              ...
              className="mt-4 rounded-full bg-[#0A2463] px-6 py-2 text-sm font-bold text-white transition hover:bg-[#0d2d6e]"
            >
              Limpar filtros
            </button>
          </div>
